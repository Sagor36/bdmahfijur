...
const Footer: React.FC = () => {
  ...
  const socials = [
    { name: 'Facebook', icon: 'fab fa-facebook-f', href: 'https://facebook.com/bdmahfijur' },
    { name: 'Instagram', icon: 'fab fa-instagram', href: 'https://instagram.com/bdmahfijur' },
    { name: 'Twitter', icon: 'fab fa-x-twitter', href: 'https://twitter.com/yourprofile' },
    { name: 'LinkedIn', icon: 'fab fa-linkedin-in', href: 'https://linkedin.com/in/itmahfijur/' },
      ...
      <footer className="footer-bg pt-24 pb-8 px-8 md:px-20 border-t border-white/5 relative z-10 bg-[#05010a] text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-5">
            ...
            <a 
              href="mailto:bdmahafijur@gmail.com" 
          ...
          <div className="md:col-span-4">
            <div className="mb-10">
              ...
              <div className="flex items-center gap-4 text-gray-400 text-lg group">
                ...
                <a href="mailto:bdmahafijur@gmail.com" className="hover:text-white transition-colors">bdmahafijur@gmail.com</a>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center gap-4 text-gray-400 text-lg group">
                ...
                <a href="https://wa.me/8801581170391" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+8801581170391</a>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-[10px] font-black uppercase tracking-[0.4em]">
            &copy; 2025 Mahfijur IT Park Agency. All Rights Reserved.
          </p>
