...
const About: React.FC = () => {
  const details = [
    { label: 'Full Name', value: 'Mahfijur Rahman' },
    { label: 'City', value: 'Rangpur, Bangladesh' },
    { label: 'Age', value: '27 Years Old' },
    { label: 'Email', value: 'bdmahafijur@gmail.com' },
      ...
      <div className="flex flex-col lg:flex-row gap-20 items-center">
        <div className="w-full lg:w-5/12 relative group cursor-pointer">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            <img 
              src="https://blogger.googleusercontent.com/img/a/AVvXsEgRmYogLDlg9JaiqVoQ-kUsV79VNaQRHh8JeaZ5wHpDJeupSzLdGyRNo_aLHjmoDOl38eh0F4T8NzfkheGMNaiN_yyZ08MJwdJHykPflMg4ij15gplbCXbU5DzMfZid4qwSmQVLBj_hcPd0lFyfu-54oE-h1uZS8Hqy1X7aGPOmNwWFGilqm42wFyv12w" 
              alt="Milon Working" 
